...
expect_equal(getHexagonAreaAvgKm2(res = c(5L, 6L)), c(252.9038581819449, 36.12906216441245))
expect_equal(getHexagonAreaAvgM2(res = c(5L, 6L)), c(252903858.1819452, 36129062.1644125))
