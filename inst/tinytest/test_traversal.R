...
expect_equal(gridRingUnsafe(cell = c("85283473fffffff", "85283423fffffff"), k = c(5L, 0L)), list(c("85291a6ffffffff", "852834d3fffffff", "852834dbfffffff", "8529a937fffffff", "8529a923fffffff", "8529a92bfffffff", "85283693fffffff", "85283683fffffff", "8528368ffffffff", "85283617fffffff", "85283607fffffff", "85283633fffffff", "85283637fffffff", "852830cbfffffff", "852830cffffffff", "8528301bfffffff", "85283013fffffff", "8528308ffffffff", "85283087fffffff", "8528354bfffffff", "85283543fffffff", "85283553fffffff", "852835cbfffffff", "852835dbfffffff", "852834a7fffffff", "852834b7fffffff", "852834b3fffffff", "85283487fffffff", "85283483fffffff", "8528349bfffffff"), c("85283423fffffff")))

expect_equal(gridPathCells(origin = c("85283473fffffff","85283473fffffff"), destination = c("85283471fffffff","8528349ffffffff")), list(c("85283473fffffff"), c("85283473fffffff", "8528340bfffffff", "85283403fffffff", "85283413fffffff", "8528348ffffffff", "85283483fffffff")))

expect_equal(gridDistance(origin = c("85283473fffffff","85283473fffffff"), destination = c("8528342bfffffff","85283477fffffff")), c(2L, 1L))

expect_equal(cellToLocalIj(origin = c("85283473fffffff","85283473fffffff"), cell = c("8528342bfffffff","85283477fffffff")), list("i" = c(25L, 26L), "j" = c(13L, 14L)))

expect_equal(localIjToCell(origin = c("85283473fffffff","85283473fffffff"), i = c(25L, 2L), j = c(13L, 1L)), c("8528342bfffffff", "852800c7fffffff"))
